  ...
  return (
    <div className="space-y-12">
      <header className="text-center py-8 bg-card shadow-lg rounded-lg border-2 border-primary/20 p-6">
        ...
        <h1 className="text-5xl font-heading text-primary mb-2">Chip Quest</h1>
      ...
      <Card className="shadow-xl border-border">
        <CardHeader>
          <CardTitle className="text-3xl font-heading text-primary/90">About the Game</CardTitle>
        </CardHeader>
      ...
      <Card className="shadow-xl border-border">
        <CardHeader>
          <CardTitle className="text-3xl font-heading text-primary/90">Development Status</CardTitle>
        </CardHeader>
        <CardContent>
